...
.TDISRes	{font-weight: bold; font-size: 10pt; color: black; font-family:
    ...
    %></a>
                        ...
                        int OBRCount = handler.getOBRCount();
                       	...
                       	//labs that fall into any of these categories have certain requirements as per Excelleris 
                            ...
                            for ( j=0; j < OBRCount; j++){
                                ...
                                for (k=0; k < obxCount; k++){
    								...
    								if(handler.getMsgType().equals("PATHL7")){
    									...
    									if((handler.getOBXIdentifier(j, k).equals("6463-4") && handler.getOBXName(j, k).equals("Culture")) || (handler.getOBXIdentifier(j, k).equals("X30011") && handler.getOBXName(j, k).equals("Organism")) || (handler.getOBXIdentifier(j, k).equals("X433") && handler.getOBXName(j, k).equals("Organism"))){
